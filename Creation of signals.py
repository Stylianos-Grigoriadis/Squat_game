...
# for i in range(1, 31):
#     print(i)
#     x_data_1, y_data_1 = lbs.creation_white_noise(number_of_data_points)
#     x_data_2, y_data_2 = lbs.creation_white_noise(number_of_data_points)
#     x_data_3, y_data_3 = lbs.creation_white_noise(number_of_data_points)
#     x_data_4, y_data_4 = lbs.creation_white_noise(number_of_data_points)
#     x_data_5, y_data_5 = lbs.creation_white_noise(number_of_data_points)
#     x_data_150 = np.concatenate((x_data_1, x_data_2, x_data_3, x_data_4, x_data_5))
#     y_data_150 = np.concatenate((y_data_1, y_data_2, y_data_3, y_data_4, y_data_5))
#     name = fr'Participant {i} random 150 targets'
#     directory = r'C:\Users\Stylianos\OneDrive - Αριστοτέλειο Πανεπιστήμιο Θεσσαλονίκης\My Files\PhD\Projects\Squat Game\Pilot Study 3\Signals'
#     lbs.create_excel_file(x_data_150, y_data_150, directory, name)

x_data_sine, y_data_sine = lbs.creation_rigid_signal(150)

name = fr'Participant repeated signal 150 targets'
directory = r'C:\Users\Stylianos\OneDrive - Αριστοτέλειο Πανεπιστήμιο Θεσσαλονίκης\My Files\PhD\Projects\Squat Game\Pilot Study 3\Signals'
lbs.create_excel_file(x_data_sine, y_data_sine, directory, name)

# Creation of signals
# directory = r'C:\Users\Stylianos\OneDrive - Αριστοτέλειο Πανεπιστήμιο Θεσσαλονίκης\My Files\PhD\Projects\Squat Game\Pilot Study 3\Signals'
#
# pink_name = r'pink_30_targets'
# sine_name = r'sine_30_targets'
# white_name = r'white_30_targets'
# lbs.create_excel_file(x_data_sine, y_data_sine, directory, sine_name)
# lbs.create_excel_file(x_data_random, y_data_random, directory, white_name)
# lbs.create_excel_file(x_data_6, y_data_6, directory, pink_name)
